...
module rec File_descriptor_set : sig
  ...
  let rec to_binary {file} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_repeated_message_field 1 File_descriptor_proto.to_binary file _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)

  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_repeated_message_field 1 File_descriptor_proto.of_binary _m
    >>= fun file -> Ok {file}

  let rec to_text {file} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_repeated_message_field "file" File_descriptor_proto.to_text file _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)

  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_repeated_message_field "file" File_descriptor_proto.of_text _m
    >>= fun file -> Ok {file}
end
...
and File_descriptor_proto : sig
  ...
  let rec to_binary
    ...
    Bin'.serialize_repeated_field 10 Field'.(Int32_t As_int) public_dependency _o
    >>= fun () ->
    Bin'.serialize_repeated_field 11 Field'.(Int32_t As_int) weak_dependency _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field 4 Descriptor_proto.to_binary message_type _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field 5 Enum_descriptor_proto.to_binary enum_type _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field 6 Service_descriptor_proto.to_binary service _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field 7 Field_descriptor_proto.to_binary extension _o
    >>= fun () ->
    Bin'.serialize_message_field 8 File_options.to_binary options _o >>= fun () ->
    Bin'.serialize_message_field 9 Source_code_info.to_binary source_code_info _o
    >>= fun () ->
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_repeated_message_field 4 Descriptor_proto.of_binary _m
    >>= fun message_type ->
    Bin'.decode_repeated_message_field 5 Enum_descriptor_proto.of_binary _m
    >>= fun enum_type ->
    Bin'.decode_repeated_message_field 6 Service_descriptor_proto.of_binary _m
    >>= fun service ->
    Bin'.decode_repeated_message_field 7 Field_descriptor_proto.of_binary _m
    >>= fun extension ->
    Bin'.decode_message_field 8 File_options.of_binary _m >>= fun options ->
    Bin'.decode_message_field 9 Source_code_info.of_binary _m >>= fun source_code_info ->
  ...
  let rec to_text
    ...
    Text'.serialize_repeated_field "dependency" Field'.String_t dependency _o
    >>= fun () ->
    Text'.serialize_repeated_field
      "public_dependency"
      Field'.(Int32_t As_int)
      public_dependency
      _o
    >>= fun () ->
    Text'.serialize_repeated_field
      ...
      _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
      "message_type"
      Descriptor_proto.to_text
      message_type
      _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
      "enum_type"
      Enum_descriptor_proto.to_text
      enum_type
      _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
      "service"
      Service_descriptor_proto.to_text
      service
      _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
      "extension"
      Field_descriptor_proto.to_text
      extension
      _o
    >>= fun () ->
    Text'.serialize_message_field "options" File_options.to_text options _o >>= fun () ->
    Text'.serialize_message_field
      "source_code_info"
      Source_code_info.to_text
      source_code_info
      _o
    >>= fun () ->
  ...
  let rec of_text input' =
    ...
    Text'.decode_repeated_field "public_dependency" Field'.(Int32_t As_int) _m
    >>= fun public_dependency ->
    Text'.decode_repeated_field "weak_dependency" Field'.(Int32_t As_int) _m
    >>= fun weak_dependency ->
    Text'.decode_repeated_message_field "message_type" Descriptor_proto.of_text _m
    >>= fun message_type ->
    Text'.decode_repeated_message_field "enum_type" Enum_descriptor_proto.of_text _m
    >>= fun enum_type ->
    Text'.decode_repeated_message_field "service" Service_descriptor_proto.of_text _m
    >>= fun service ->
    Text'.decode_repeated_message_field "extension" Field_descriptor_proto.of_text _m
    >>= fun extension ->
    Text'.decode_message_field "options" File_options.of_text _m >>= fun options ->
    Text'.decode_message_field "source_code_info" Source_code_info.of_text _m
    >>= fun source_code_info ->
...
and Descriptor_proto : sig
  ...
  module rec Extension_range : sig
    ...
    let rec to_binary {start; end'; options} =
      let _o = Runtime.Byte_output.create () in
      ...
      Bin'.serialize_message_field 3 Extension_range_options.to_binary options _o
      >>= fun () -> Ok (Runtime.Byte_output.contents _o)
    ...
    let rec to_text {start; end'; options} =
      let _o = Runtime.Byte_output.create () in
      Text'.serialize_optional_field "start" Field'.(Int32_t As_int) start _o
      >>= fun () ->
      Text'.serialize_optional_field "end" Field'.(Int32_t As_int) end' _o >>= fun () ->
      Text'.serialize_message_field "options" Extension_range_options.to_text options _o
      >>= fun () -> Ok (Runtime.Byte_output.contents _o)
    ...
    let rec of_text input' =
      ...
      Text'.decode_message_field "options" Extension_range_options.of_text _m
      >>= fun options -> Ok {start; end'; options}
  end
  ...
  let rec to_binary
    ...
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_optional_field 1 Field'.String_t name _o >>= fun () ->
    Bin'.serialize_repeated_message_field 2 Field_descriptor_proto.to_binary field _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field 6 Field_descriptor_proto.to_binary extension _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field 3 Descriptor_proto.to_binary nested_type _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field 4 Enum_descriptor_proto.to_binary enum_type _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field
      5
      Descriptor_proto.Extension_range.to_binary
      extension_range
      _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field
      8
      Oneof_descriptor_proto.to_binary
      oneof_decl
      _o
    >>= fun () ->
    Bin'.serialize_message_field 7 Message_options.to_binary options _o >>= fun () ->
    Bin'.serialize_repeated_message_field
      9
      Descriptor_proto.Reserved_range.to_binary
      reserved_range
      _o
    >>= fun () ->
  ...
  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_optional_field 1 Field'.String_t _m >>= fun name ->
    Bin'.decode_repeated_message_field 2 Field_descriptor_proto.of_binary _m
    >>= fun field ->
    Bin'.decode_repeated_message_field 6 Field_descriptor_proto.of_binary _m
    >>= fun extension ->
    Bin'.decode_repeated_message_field 3 Descriptor_proto.of_binary _m
    >>= fun nested_type ->
    Bin'.decode_repeated_message_field 4 Enum_descriptor_proto.of_binary _m
    >>= fun enum_type ->
    Bin'.decode_repeated_message_field 5 Descriptor_proto.Extension_range.of_binary _m
    >>= fun extension_range ->
    Bin'.decode_repeated_message_field 8 Oneof_descriptor_proto.of_binary _m
    >>= fun oneof_decl ->
    Bin'.decode_message_field 7 Message_options.of_binary _m >>= fun options ->
    Bin'.decode_repeated_message_field 9 Descriptor_proto.Reserved_range.of_binary _m
    >>= fun reserved_range ->
  ...
  let rec to_text
    ...
    Text'.serialize_repeated_message_field
      "extension_range"
      Descriptor_proto.Extension_range.to_text
      extension_range
      _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
      "oneof_decl"
      Oneof_descriptor_proto.to_text
      oneof_decl
      _o
    >>= fun () ->
    Text'.serialize_message_field "options" Message_options.to_text options _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
      "reserved_range"
      Descriptor_proto.Reserved_range.to_text
      reserved_range
      _o
    >>= fun () ->
    Text'.serialize_repeated_field "reserved_name" Field'.String_t reserved_name _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)

  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_optional_field "name" Field'.String_t _m >>= fun name ->
    Text'.decode_repeated_message_field "field" Field_descriptor_proto.of_text _m
    >>= fun field ->
    Text'.decode_repeated_message_field "extension" Field_descriptor_proto.of_text _m
    >>= fun extension ->
    Text'.decode_repeated_message_field "nested_type" Descriptor_proto.of_text _m
    >>= fun nested_type ->
    Text'.decode_repeated_message_field "enum_type" Enum_descriptor_proto.of_text _m
    >>= fun enum_type ->
    Text'.decode_repeated_message_field
      "extension_range"
      Descriptor_proto.Extension_range.of_text
      _m
    >>= fun extension_range ->
    Text'.decode_repeated_message_field "oneof_decl" Oneof_descriptor_proto.of_text _m
    >>= fun oneof_decl ->
    Text'.decode_message_field "options" Message_options.of_text _m >>= fun options ->
    Text'.decode_repeated_message_field
      "reserved_range"
      Descriptor_proto.Reserved_range.of_text
      _m
    >>= fun reserved_range ->
    Text'.decode_repeated_field "reserved_name" Field'.String_t _m
    >>= fun reserved_name ->
    Ok
      {
        name;
...
and Extension_range_options : sig
  type t = {uninterpreted_option : Uninterpreted_option.t list} [@@deriving eq, show]
  ...
  let rec to_binary {uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_repeated_message_field
      999
      Uninterpreted_option.to_binary
  ...
  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_repeated_message_field 999 Uninterpreted_option.of_binary _m
    >>= fun uninterpreted_option -> Ok {uninterpreted_option}

  let rec to_text {uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_repeated_message_field
      "uninterpreted_option"
      Uninterpreted_option.to_text
      uninterpreted_option
      _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
...
and Field_descriptor_proto : sig
  ...
  let rec to_binary
    ...
    Bin'.serialize_enum_field 4 Field_descriptor_proto.Label.to_int label _o
    >>= fun () ->
    Bin'.serialize_enum_field 5 Field_descriptor_proto.Type'.to_int type' _o
    >>= fun () ->
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_enum_field
      4
      Field_descriptor_proto.Label.of_int
      Field_descriptor_proto.Label.default
      _m
    >>= fun label ->
    Bin'.decode_enum_field
      5
      Field_descriptor_proto.Type'.of_int
      Field_descriptor_proto.Type'.default
      _m
    >>= fun type' ->
  ...
  let rec to_text
    ...
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "name" Field'.String_t name _o >>= fun () ->
    Text'.serialize_optional_field "number" Field'.(Int32_t As_int) number _o
    >>= fun () ->
    Text'.serialize_enum_field "label" Field_descriptor_proto.Label.to_string label _o
    >>= fun () ->
    Text'.serialize_enum_field "type" Field_descriptor_proto.Type'.to_string type' _o
    >>= fun () ->
    ...
    Text'.serialize_optional_field "default_value" Field'.String_t default_value _o
    >>= fun () ->
    Text'.serialize_optional_field "oneof_index" Field'.(Int32_t As_int) oneof_index _o
    >>= fun () ->
    Text'.serialize_optional_field "json_name" Field'.String_t json_name _o >>= fun () ->
    Text'.serialize_message_field "options" Field_options.to_text options _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
  ...
  let rec of_text input' =
    ...
    Text'.decode_enum_field
      "label"
      Field_descriptor_proto.Label.of_string
      Field_descriptor_proto.Label.default
      _m
    >>= fun label ->
    Text'.decode_enum_field
      "type"
      Field_descriptor_proto.Type'.of_string
      Field_descriptor_proto.Type'.default
      _m
    >>= fun type' ->
    ...
    Text'.decode_optional_field "default_value" Field'.String_t _m
    >>= fun default_value ->
    Text'.decode_optional_field "oneof_index" Field'.(Int32_t As_int) _m
    >>= fun oneof_index ->
...
and Oneof_descriptor_proto : sig
  ...
  let rec to_binary {name; options} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_optional_field 1 Field'.String_t name _o >>= fun () ->
    Bin'.serialize_message_field 2 Oneof_options.to_binary options _o >>= fun () ->
    Ok (Runtime.Byte_output.contents _o)

  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_optional_field 1 Field'.String_t _m >>= fun name ->
    Bin'.decode_message_field 2 Oneof_options.of_binary _m >>= fun options ->
    Ok {name; options}

  let rec to_text {name; options} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "name" Field'.String_t name _o >>= fun () ->
    Text'.serialize_message_field "options" Oneof_options.to_text options _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)

  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_optional_field "name" Field'.String_t _m >>= fun name ->
    Text'.decode_message_field "options" Oneof_options.of_text _m >>= fun options ->
    Ok {name; options}
end
...
and Enum_descriptor_proto : sig
  ...
  let rec to_binary {name; value'; options; reserved_range; reserved_name} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_optional_field 1 Field'.String_t name _o >>= fun () ->
    Bin'.serialize_repeated_message_field
      2
      Enum_value_descriptor_proto.to_binary
      value'
      _o
    >>= fun () ->
    Bin'.serialize_message_field 3 Enum_options.to_binary options _o >>= fun () ->
    Bin'.serialize_repeated_message_field
      4
      Enum_descriptor_proto.Enum_reserved_range.to_binary
      reserved_range
      _o
    >>= fun () ->
  ...
  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_optional_field 1 Field'.String_t _m >>= fun name ->
    Bin'.decode_repeated_message_field 2 Enum_value_descriptor_proto.of_binary _m
    >>= fun value' ->
    Bin'.decode_message_field 3 Enum_options.of_binary _m >>= fun options ->
    Bin'.decode_repeated_message_field
      4
      Enum_descriptor_proto.Enum_reserved_range.of_binary
      _m
    >>= fun reserved_range ->
    Bin'.decode_repeated_field 5 Field'.String_t _m >>= fun reserved_name ->
    Ok {name; value'; options; reserved_range; reserved_name}

  let rec to_text {name; value'; options; reserved_range; reserved_name} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "name" Field'.String_t name _o >>= fun () ->
    Text'.serialize_repeated_message_field
      "value"
      Enum_value_descriptor_proto.to_text
      value'
      _o
    >>= fun () ->
    Text'.serialize_message_field "options" Enum_options.to_text options _o >>= fun () ->
    Text'.serialize_repeated_message_field
      "reserved_range"
      Enum_descriptor_proto.Enum_reserved_range.to_text
      reserved_range
      _o
    >>= fun () ->
    Text'.serialize_repeated_field "reserved_name" Field'.String_t reserved_name _o
  ...
  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_optional_field "name" Field'.String_t _m >>= fun name ->
    Text'.decode_repeated_message_field "value" Enum_value_descriptor_proto.of_text _m
    >>= fun value' ->
    Text'.decode_message_field "options" Enum_options.of_text _m >>= fun options ->
    Text'.decode_repeated_message_field
      "reserved_range"
      Enum_descriptor_proto.Enum_reserved_range.of_text
      _m
    >>= fun reserved_range ->
    Text'.decode_repeated_field "reserved_name" Field'.String_t _m
    >>= fun reserved_name -> Ok {name; value'; options; reserved_range; reserved_name}
end
...
and Enum_value_descriptor_proto : sig
  ...
  let rec to_binary {name; number; options} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_optional_field 1 Field'.String_t name _o >>= fun () ->
  ...
  let rec to_text {name; number; options} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "name" Field'.String_t name _o >>= fun () ->
    Text'.serialize_optional_field "number" Field'.(Int32_t As_int) number _o
    >>= fun () ->
    Text'.serialize_message_field "options" Enum_value_options.to_text options _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
...
and Service_descriptor_proto : sig
  ...
  let rec to_binary {name; method'; options} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_optional_field 1 Field'.String_t name _o >>= fun () ->
    Bin'.serialize_repeated_message_field 2 Method_descriptor_proto.to_binary method' _o
    >>= fun () ->
    Bin'.serialize_message_field 3 Service_options.to_binary options _o >>= fun () ->
    Ok (Runtime.Byte_output.contents _o)

  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_optional_field 1 Field'.String_t _m >>= fun name ->
    Bin'.decode_repeated_message_field 2 Method_descriptor_proto.of_binary _m
    >>= fun method' ->
    Bin'.decode_message_field 3 Service_options.of_binary _m >>= fun options ->
    Ok {name; method'; options}

  let rec to_text {name; method'; options} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "name" Field'.String_t name _o >>= fun () ->
    Text'.serialize_repeated_message_field
      "method"
      Method_descriptor_proto.to_text
      method'
      _o
    >>= fun () ->
    Text'.serialize_message_field "options" Service_options.to_text options _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)

  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_optional_field "name" Field'.String_t _m >>= fun name ->
    Text'.decode_repeated_message_field "method" Method_descriptor_proto.of_text _m
    >>= fun method' ->
    Text'.decode_message_field "options" Service_options.of_text _m >>= fun options ->
    Ok {name; method'; options}
end
...
and Method_descriptor_proto : sig
  ...
  let rec to_binary
    ...
    Bin'.serialize_message_field 4 Method_options.to_binary options _o >>= fun () ->
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_message_field 4 Method_options.of_binary _m >>= fun options ->
  ...
  let rec to_text
    ...
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "name" Field'.String_t name _o >>= fun () ->
    Text'.serialize_optional_field "input_type" Field'.String_t input_type _o
    >>= fun () ->
    Text'.serialize_optional_field "output_type" Field'.String_t output_type _o
    >>= fun () ->
    Text'.serialize_message_field "options" Method_options.to_text options _o
    >>= fun () ->
    Text'.serialize_optional_field "client_streaming" Field'.Bool_t client_streaming _o
    >>= fun () ->
    Text'.serialize_optional_field "server_streaming" Field'.Bool_t server_streaming _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
  ...
  let rec of_text input' =
    ...
    Text'.decode_message_field "options" Method_options.of_text _m >>= fun options ->
    Text'.decode_optional_field "client_streaming" Field'.Bool_t _m
    >>= fun client_streaming ->
    Text'.decode_optional_field "server_streaming" Field'.Bool_t _m
    >>= fun server_streaming ->
    Ok {name; input_type; output_type; options; client_streaming; server_streaming}
end
...
and File_options : sig
  ...
  let rec to_binary
    ...
    Bin'.serialize_optional_field 20 Field'.Bool_t java_generate_equals_and_hash _o
    >>= fun () ->
    Bin'.serialize_optional_field 27 Field'.Bool_t java_string_check_utf8 _o
    >>= fun () ->
    Bin'.serialize_enum_field 9 File_options.Optimize_mode.to_int optimize_for _o
    >>= fun () ->
    ...
    Bin'.serialize_optional_field 44 Field'.String_t php_metadata_namespace _o
    >>= fun () ->
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_optional_field 20 Field'.Bool_t _m
    >>= fun java_generate_equals_and_hash ->
    Bin'.decode_optional_field 27 Field'.Bool_t _m >>= fun java_string_check_utf8 ->
    Bin'.decode_enum_field
      9
      File_options.Optimize_mode.of_int
      File_options.Optimize_mode.default
      _m
    >>= fun optimize_for ->
  ...
  let rec to_text
    ...
    =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "java_package" Field'.String_t java_package _o
    >>= fun () ->
    Text'.serialize_optional_field
      "java_outer_classname"
      Field'.String_t
      java_outer_classname
      _o
    ...
    Text'.serialize_optional_field
      ...
      _o
    >>= fun () ->
    Text'.serialize_enum_field
      "optimize_for"
      File_options.Optimize_mode.to_string
      optimize_for
      _o
    >>= fun () ->
    Text'.serialize_optional_field "go_package" Field'.String_t go_package _o
    >>= fun () ->
    Text'.serialize_optional_field
      "cc_generic_services"
      Field'.Bool_t
    ...
    Text'.serialize_optional_field "cc_enable_arenas" Field'.Bool_t cc_enable_arenas _o
    >>= fun () ->
    Text'.serialize_optional_field
      "objc_class_prefix"
      Field'.String_t
      ...
      _o
    >>= fun () ->
    Text'.serialize_optional_field "csharp_namespace" Field'.String_t csharp_namespace _o
    >>= fun () ->
    Text'.serialize_optional_field "swift_prefix" Field'.String_t swift_prefix _o
    >>= fun () ->
    Text'.serialize_optional_field "php_class_prefix" Field'.String_t php_class_prefix _o
    >>= fun () ->
    Text'.serialize_optional_field "php_namespace" Field'.String_t php_namespace _o
    >>= fun () ->
    Text'.serialize_optional_field
      "php_metadata_namespace"
      Field'.String_t
      ...
      _o
    >>= fun () ->
    Text'.serialize_optional_field "ruby_package" Field'.String_t ruby_package _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
      "uninterpreted_option"
      Uninterpreted_option.to_text
  ...
  let rec of_text input' =
    ...
    Text'.decode_optional_field "java_outer_classname" Field'.String_t _m
    >>= fun java_outer_classname ->
    Text'.decode_optional_field "java_multiple_files" Field'.Bool_t _m
    >>= fun java_multiple_files ->
    Text'.decode_optional_field "java_generate_equals_and_hash" Field'.Bool_t _m
    >>= fun java_generate_equals_and_hash ->
    Text'.decode_optional_field "java_string_check_utf8" Field'.Bool_t _m
    >>= fun java_string_check_utf8 ->
    Text'.decode_enum_field
      "optimize_for"
      File_options.Optimize_mode.of_string
      File_options.Optimize_mode.default
      _m
    >>= fun optimize_for ->
    Text'.decode_optional_field "go_package" Field'.String_t _m >>= fun go_package ->
    Text'.decode_optional_field "cc_generic_services" Field'.Bool_t _m
    >>= fun cc_generic_services ->
    Text'.decode_optional_field "java_generic_services" Field'.Bool_t _m
    >>= fun java_generic_services ->
    Text'.decode_optional_field "py_generic_services" Field'.Bool_t _m
    >>= fun py_generic_services ->
    Text'.decode_optional_field "php_generic_services" Field'.Bool_t _m
    >>= fun php_generic_services ->
    Text'.decode_optional_field "deprecated" Field'.Bool_t _m >>= fun deprecated ->
    Text'.decode_optional_field "cc_enable_arenas" Field'.Bool_t _m
    >>= fun cc_enable_arenas ->
    Text'.decode_optional_field "objc_class_prefix" Field'.String_t _m
    >>= fun objc_class_prefix ->
    Text'.decode_optional_field "csharp_namespace" Field'.String_t _m
    >>= fun csharp_namespace ->
    Text'.decode_optional_field "swift_prefix" Field'.String_t _m >>= fun swift_prefix ->
    Text'.decode_optional_field "php_class_prefix" Field'.String_t _m
    >>= fun php_class_prefix ->
    Text'.decode_optional_field "php_namespace" Field'.String_t _m
    >>= fun php_namespace ->
    Text'.decode_optional_field "php_metadata_namespace" Field'.String_t _m
    >>= fun php_metadata_namespace ->
...
and Message_options : sig
  ...
  let rec to_binary
    ...
    =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_optional_field 1 Field'.Bool_t message_set_wire_format _o
    >>= fun () ->
    Bin'.serialize_optional_field 2 Field'.Bool_t no_standard_descriptor_accessor _o
    >>= fun () ->
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_optional_field 2 Field'.Bool_t _m
    >>= fun no_standard_descriptor_accessor ->
  ...
  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_optional_field "message_set_wire_format" Field'.Bool_t _m
    >>= fun message_set_wire_format ->
    Text'.decode_optional_field "no_standard_descriptor_accessor" Field'.Bool_t _m
    >>= fun no_standard_descriptor_accessor ->
    Text'.decode_optional_field "deprecated" Field'.Bool_t _m >>= fun deprecated ->
...
and Field_options : sig
  ...
  let rec to_binary
      {ctype; packed; jstype; lazy'; deprecated; weak; uninterpreted_option}
    =
    let _o = Runtime.Byte_output.create () in
  ...
  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_enum_field 1 Field_options.C_type.of_int Field_options.C_type.default _m
    >>= fun ctype ->
    Bin'.decode_optional_field 2 Field'.Bool_t _m >>= fun packed ->
    Bin'.decode_enum_field
      6
      Field_options.J_s_type.of_int
      Field_options.J_s_type.default
      _m
    >>= fun jstype ->
  ...
  let rec to_text {ctype; packed; jstype; lazy'; deprecated; weak; uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_enum_field "ctype" Field_options.C_type.to_string ctype _o
    >>= fun () ->
    Text'.serialize_optional_field "packed" Field'.Bool_t packed _o >>= fun () ->
    Text'.serialize_enum_field "jstype" Field_options.J_s_type.to_string jstype _o
    >>= fun () ->
  ...
  let rec of_text input' =
    ...
    Text'.decode_enum_field
      "ctype"
      Field_options.C_type.of_string
      Field_options.C_type.default
      _m
    >>= fun ctype ->
    Text'.decode_optional_field "packed" Field'.Bool_t _m >>= fun packed ->
    Text'.decode_enum_field
      "jstype"
      Field_options.J_s_type.of_string
      Field_options.J_s_type.default
      _m
    >>= fun jstype ->
...
and Enum_options : sig
  ...
  let rec to_binary {allow_alias; deprecated; uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_optional_field 3 Field'.Bool_t _m >>= fun deprecated ->
    Bin'.decode_repeated_message_field 999 Uninterpreted_option.of_binary _m
    >>= fun uninterpreted_option -> Ok {allow_alias; deprecated; uninterpreted_option}

  let rec to_text {allow_alias; deprecated; uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "allow_alias" Field'.Bool_t allow_alias _o
    >>= fun () ->
    Text'.serialize_optional_field "deprecated" Field'.Bool_t deprecated _o >>= fun () ->
    Text'.serialize_repeated_message_field
      "uninterpreted_option"
...
and Enum_value_options : sig
  ...
  let rec to_binary {deprecated; uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_repeated_message_field 999 Uninterpreted_option.of_binary _m
    >>= fun uninterpreted_option -> Ok {deprecated; uninterpreted_option}

  let rec to_text {deprecated; uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "deprecated" Field'.Bool_t deprecated _o >>= fun () ->
    Text'.serialize_repeated_message_field
      "uninterpreted_option"
...
and Method_options : sig
  ...
  module Idempotency_level : sig
    ...
    let default () = Idempotency_unknown
  ...
  let rec to_binary {deprecated; idempotency_level; uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_optional_field 33 Field'.Bool_t deprecated _o >>= fun () ->
    Bin'.serialize_enum_field
      34
      Method_options.Idempotency_level.to_int
      idempotency_level
      _o
    >>= fun () ->
    Bin'.serialize_repeated_message_field
  ...
  let rec of_binary input' =
    ...
    Bin'.decode_enum_field
      34
      Method_options.Idempotency_level.of_int
      Method_options.Idempotency_level.default
      _m
    >>= fun idempotency_level ->
    Bin'.decode_repeated_message_field 999 Uninterpreted_option.of_binary _m
    >>= fun uninterpreted_option ->
    Ok {deprecated; idempotency_level; uninterpreted_option}

  let rec to_text {deprecated; idempotency_level; uninterpreted_option} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_optional_field "deprecated" Field'.Bool_t deprecated _o >>= fun () ->
    Text'.serialize_enum_field
      "idempotency_level"
      Method_options.Idempotency_level.to_string
      idempotency_level
      _o
    >>= fun () ->
    Text'.serialize_repeated_message_field
  ...
  let rec of_text input' =
    ...
    Text'.decode_enum_field
      "idempotency_level"
      Method_options.Idempotency_level.of_string
      Method_options.Idempotency_level.default
      _m
    >>= fun idempotency_level ->
    Text'.decode_repeated_message_field
...
and Uninterpreted_option : sig
  ...
  module rec Name_part : sig
    ...
    let rec to_binary {name_part; is_extension} =
      let _o = Runtime.Byte_output.create () in
    ...
    let rec to_text {name_part; is_extension} =
      let _o = Runtime.Byte_output.create () in
      Text'.serialize_optional_field "name_part" Field'.String_t name_part _o
      >>= fun () ->
      Text'.serialize_optional_field "is_extension" Field'.Bool_t is_extension _o
      >>= fun () -> Ok (Runtime.Byte_output.contents _o)
  ...
  let rec to_binary
    ...
    Bin'.serialize_repeated_message_field
      2
      Uninterpreted_option.Name_part.to_binary
      name
      _o
    >>= fun () ->
    Bin'.serialize_optional_field 3 Field'.String_t identifier_value _o >>= fun () ->
    Bin'.serialize_optional_field 4 Field'.(Uint64_t As_int) positive_int_value _o
    >>= fun () ->
    Bin'.serialize_optional_field 5 Field'.(Int64_t As_int) negative_int_value _o
    >>= fun () ->
  ...
  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_repeated_message_field 2 Uninterpreted_option.Name_part.of_binary _m
    >>= fun name ->
    Bin'.decode_optional_field 3 Field'.String_t _m >>= fun identifier_value ->
    Bin'.decode_optional_field 4 Field'.(Uint64_t As_int) _m
    >>= fun positive_int_value ->
  ...
  let rec to_text
    ...
    Text'.serialize_repeated_message_field
      "name"
      Uninterpreted_option.Name_part.to_text
      name
      _o
    >>= fun () ->
    Text'.serialize_optional_field "identifier_value" Field'.String_t identifier_value _o
    >>= fun () ->
    Text'.serialize_optional_field
      "positive_int_value"
      Field'.(Uint64_t As_int)
      positive_int_value
      _o
    >>= fun () ->
    Text'.serialize_optional_field
      "negative_int_value"
      Field'.(Int64_t As_int)
      negative_int_value
      _o
    >>= fun () ->
    Text'.serialize_optional_field "double_value" Field'.Double_t double_value _o
    >>= fun () ->
    Text'.serialize_optional_field "string_value" Field'.Bytes_t string_value _o
    >>= fun () ->
    Text'.serialize_optional_field "aggregate_value" Field'.String_t aggregate_value _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)

  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_repeated_message_field "name" Uninterpreted_option.Name_part.of_text _m
    >>= fun name ->
    Text'.decode_optional_field "identifier_value" Field'.String_t _m
    >>= fun identifier_value ->
    Text'.decode_optional_field "positive_int_value" Field'.(Uint64_t As_int) _m
    >>= fun positive_int_value ->
    Text'.decode_optional_field "negative_int_value" Field'.(Int64_t As_int) _m
    >>= fun negative_int_value ->
    ...
    Text'.decode_optional_field "aggregate_value" Field'.String_t _m
    >>= fun aggregate_value ->
    Ok
      {
        name;
...
and Source_code_info : sig
  ...
  type t = {location : Source_code_info.Location.t list} [@@deriving eq, show]
  ...
  module rec Location : sig
    ...
    let rec to_binary
      ...
      Bin'.serialize_repeated_field 6 Field'.String_t leading_detached_comments _o
      >>= fun () -> Ok (Runtime.Byte_output.contents _o)
    ...
    let rec of_binary input' =
      ...
      Bin'.decode_repeated_field 6 Field'.String_t _m
      >>= fun leading_detached_comments ->
    ...
    let rec of_text input' =
      ...
      Text'.decode_optional_field "leading_comments" Field'.String_t _m
      >>= fun leading_comments ->
      Text'.decode_optional_field "trailing_comments" Field'.String_t _m
      >>= fun trailing_comments ->
      Text'.decode_repeated_field "leading_detached_comments" Field'.String_t _m
      >>= fun leading_detached_comments ->
      Ok {path; span; leading_comments; trailing_comments; leading_detached_comments}
  end
  ...
  let rec to_binary {location} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_repeated_message_field
      1
      Source_code_info.Location.to_binary
      location
      _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
  ...
  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_repeated_message_field 1 Source_code_info.Location.of_binary _m
    >>= fun location -> Ok {location}

  let rec to_text {location} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_repeated_message_field
      "location"
      Source_code_info.Location.to_text
      location
      _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
  ...
  let rec of_text input' =
    Ok (Runtime.Byte_input.create input') >>= Text'.deserialize_message >>= fun _m ->
    Text'.decode_repeated_message_field "location" Source_code_info.Location.of_text _m
    >>= fun location -> Ok {location}
end
...
and Generated_code_info : sig
  ...
  type t = {annotation : Generated_code_info.Annotation.t list} [@@deriving eq, show]
  ...
  module rec Annotation : sig
    ...
    let rec to_binary {path; source_file; begin'; end'} =
      let _o = Runtime.Byte_output.create () in
      Bin'.serialize_repeated_field 1 Field'.(Int32_t As_int) path _o >>= fun () ->
    ...
    let rec to_text {path; source_file; begin'; end'} =
      let _o = Runtime.Byte_output.create () in
      Text'.serialize_repeated_field "path" Field'.(Int32_t As_int) path _o >>= fun () ->
      Text'.serialize_optional_field "source_file" Field'.String_t source_file _o
      >>= fun () ->
      Text'.serialize_optional_field "begin" Field'.(Int32_t As_int) begin' _o
      >>= fun () ->
      Text'.serialize_optional_field "end" Field'.(Int32_t As_int) end' _o >>= fun () ->
      Ok (Runtime.Byte_output.contents _o)
  ...
  let rec to_binary {annotation} =
    let _o = Runtime.Byte_output.create () in
    Bin'.serialize_repeated_message_field
      1
      Generated_code_info.Annotation.to_binary
      annotation
      _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
  ...
  let rec of_binary input' =
    Ok (Runtime.Byte_input.create input') >>= Bin'.deserialize_message >>= fun _m ->
    Bin'.decode_repeated_message_field 1 Generated_code_info.Annotation.of_binary _m
    >>= fun annotation -> Ok {annotation}

  let rec to_text {annotation} =
    let _o = Runtime.Byte_output.create () in
    Text'.serialize_repeated_message_field
      "annotation"
      Generated_code_info.Annotation.to_text
      annotation
      _o
    >>= fun () -> Ok (Runtime.Byte_output.contents _o)
  ...
  let rec of_text input' =
    ...
    Text'.decode_repeated_message_field
      "annotation"
      Generated_code_info.Annotation.of_text
      _m
    >>= fun annotation -> Ok {annotation}
end
