...
let rec pp_field_descriptor_proto_label fmt (v:Descriptor_types.field_descriptor_proto_label) =
  match v with
...
let rec pp_field_descriptor_proto_type fmt (v:Descriptor_types.field_descriptor_proto_type) =
  match v with
...
let rec pp_uninterpreted_option_name_part fmt (v:Descriptor_types.uninterpreted_option_name_part) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "name_part" Pbrt.Pp.pp_string fmt v.Descriptor_types.name_part;
    Pbrt.Pp.pp_record_field "is_extension" Pbrt.Pp.pp_bool fmt v.Descriptor_types.is_extension;
...
let rec pp_field_options fmt (v:Descriptor_types.field_options) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "ctype" (Pbrt.Pp.pp_option pp_field_options_ctype) fmt v.Descriptor_types.ctype;
    Pbrt.Pp.pp_record_field "packed" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.packed;
    Pbrt.Pp.pp_record_field "jstype" (Pbrt.Pp.pp_option pp_field_options_jstype) fmt v.Descriptor_types.jstype;
    Pbrt.Pp.pp_record_field "lazy_" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.lazy_;
    Pbrt.Pp.pp_record_field "deprecated" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.deprecated;
    Pbrt.Pp.pp_record_field "weak" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.weak;
    Pbrt.Pp.pp_record_field "uninterpreted_option" (Pbrt.Pp.pp_list pp_uninterpreted_option) fmt v.Descriptor_types.uninterpreted_option;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_enum_value_descriptor_proto fmt (v:Descriptor_types.enum_value_descriptor_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "name" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.name;
    Pbrt.Pp.pp_record_field "number" (Pbrt.Pp.pp_option Pbrt.Pp.pp_int) fmt v.Descriptor_types.number;
...
let rec pp_enum_options fmt (v:Descriptor_types.enum_options) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "allow_alias" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.allow_alias;
    Pbrt.Pp.pp_record_field "deprecated" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.deprecated;
    Pbrt.Pp.pp_record_field "uninterpreted_option" (Pbrt.Pp.pp_list pp_uninterpreted_option) fmt v.Descriptor_types.uninterpreted_option;
    Format.pp_close_box fmt ()
  in
...
let rec pp_enum_descriptor_proto fmt (v:Descriptor_types.enum_descriptor_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "name" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.name;
    Pbrt.Pp.pp_record_field "value" (Pbrt.Pp.pp_list pp_enum_value_descriptor_proto) fmt v.Descriptor_types.value;
    Pbrt.Pp.pp_record_field "options" (Pbrt.Pp.pp_option pp_enum_options) fmt v.Descriptor_types.options;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_oneof_descriptor_proto fmt (v:Descriptor_types.oneof_descriptor_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "name" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.name;
    Pbrt.Pp.pp_record_field "options" (Pbrt.Pp.pp_option pp_oneof_options) fmt v.Descriptor_types.options;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_message_options fmt (v:Descriptor_types.message_options) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "message_set_wire_format" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.message_set_wire_format;
    Pbrt.Pp.pp_record_field "no_standard_descriptor_accessor" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.no_standard_descriptor_accessor;
    Pbrt.Pp.pp_record_field "deprecated" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.deprecated;
    Pbrt.Pp.pp_record_field "map_entry" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.map_entry;
    Pbrt.Pp.pp_record_field "uninterpreted_option" (Pbrt.Pp.pp_list pp_uninterpreted_option) fmt v.Descriptor_types.uninterpreted_option;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_descriptor_proto fmt (v:Descriptor_types.descriptor_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "name" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.name;
    Pbrt.Pp.pp_record_field "field" (Pbrt.Pp.pp_list pp_field_descriptor_proto) fmt v.Descriptor_types.field;
    Pbrt.Pp.pp_record_field "extension" (Pbrt.Pp.pp_list pp_field_descriptor_proto) fmt v.Descriptor_types.extension;
    Pbrt.Pp.pp_record_field "nested_type" (Pbrt.Pp.pp_list pp_descriptor_proto) fmt v.Descriptor_types.nested_type;
    Pbrt.Pp.pp_record_field "enum_type" (Pbrt.Pp.pp_list pp_enum_descriptor_proto) fmt v.Descriptor_types.enum_type;
    Pbrt.Pp.pp_record_field "extension_range" (Pbrt.Pp.pp_list pp_descriptor_proto_extension_range) fmt v.Descriptor_types.extension_range;
    Pbrt.Pp.pp_record_field "oneof_decl" (Pbrt.Pp.pp_list pp_oneof_descriptor_proto) fmt v.Descriptor_types.oneof_decl;
    Pbrt.Pp.pp_record_field "options" (Pbrt.Pp.pp_option pp_message_options) fmt v.Descriptor_types.options;
    Pbrt.Pp.pp_record_field "reserved_range" (Pbrt.Pp.pp_list pp_descriptor_proto_reserved_range) fmt v.Descriptor_types.reserved_range;
    Pbrt.Pp.pp_record_field "reserved_name" (Pbrt.Pp.pp_list Pbrt.Pp.pp_string) fmt v.Descriptor_types.reserved_name;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_method_descriptor_proto fmt (v:Descriptor_types.method_descriptor_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "name" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.name;
    Pbrt.Pp.pp_record_field "input_type" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.input_type;
    Pbrt.Pp.pp_record_field "output_type" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.output_type;
    Pbrt.Pp.pp_record_field "options" (Pbrt.Pp.pp_option pp_method_options) fmt v.Descriptor_types.options;
    Pbrt.Pp.pp_record_field "client_streaming" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.client_streaming;
    Pbrt.Pp.pp_record_field "server_streaming" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.server_streaming;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_service_descriptor_proto fmt (v:Descriptor_types.service_descriptor_proto) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "name" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.name;
    Pbrt.Pp.pp_record_field "method_" (Pbrt.Pp.pp_list pp_method_descriptor_proto) fmt v.Descriptor_types.method_;
    Pbrt.Pp.pp_record_field "options" (Pbrt.Pp.pp_option pp_service_options) fmt v.Descriptor_types.options;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()

let rec pp_file_options_optimize_mode fmt (v:Descriptor_types.file_options_optimize_mode) =
  match v with
...
let rec pp_file_options fmt (v:Descriptor_types.file_options) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "java_package" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.java_package;
    Pbrt.Pp.pp_record_field "java_outer_classname" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.java_outer_classname;
    Pbrt.Pp.pp_record_field "java_multiple_files" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.java_multiple_files;
    Pbrt.Pp.pp_record_field "java_generate_equals_and_hash" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.java_generate_equals_and_hash;
    Pbrt.Pp.pp_record_field "java_string_check_utf8" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.java_string_check_utf8;
    Pbrt.Pp.pp_record_field "optimize_for" (Pbrt.Pp.pp_option pp_file_options_optimize_mode) fmt v.Descriptor_types.optimize_for;
    Pbrt.Pp.pp_record_field "go_package" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.go_package;
    Pbrt.Pp.pp_record_field "cc_generic_services" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.cc_generic_services;
    Pbrt.Pp.pp_record_field "java_generic_services" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.java_generic_services;
    Pbrt.Pp.pp_record_field "py_generic_services" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.py_generic_services;
    Pbrt.Pp.pp_record_field "deprecated" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.deprecated;
    Pbrt.Pp.pp_record_field "cc_enable_arenas" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.cc_enable_arenas;
    Pbrt.Pp.pp_record_field "objc_class_prefix" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.objc_class_prefix;
    Pbrt.Pp.pp_record_field "csharp_namespace" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.csharp_namespace;
    Pbrt.Pp.pp_record_field "uninterpreted_option" (Pbrt.Pp.pp_list pp_uninterpreted_option) fmt v.Descriptor_types.uninterpreted_option;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_source_code_info fmt (v:Descriptor_types.source_code_info) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "location" (Pbrt.Pp.pp_list pp_source_code_info_location) fmt v.Descriptor_types.location;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_file_descriptor_proto fmt (v:Descriptor_types.file_descriptor_proto) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "extension" (Pbrt.Pp.pp_list pp_field_descriptor_proto) fmt v.Descriptor_types.extension;
    Pbrt.Pp.pp_record_field "options" (Pbrt.Pp.pp_option pp_file_options) fmt v.Descriptor_types.options;
    Pbrt.Pp.pp_record_field "source_code_info" (Pbrt.Pp.pp_option pp_source_code_info) fmt v.Descriptor_types.source_code_info;
    Pbrt.Pp.pp_record_field "syntax" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.syntax;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_file_descriptor_set fmt (v:Descriptor_types.file_descriptor_set) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "file" (Pbrt.Pp.pp_list pp_file_descriptor_proto) fmt v.Descriptor_types.file;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_generated_code_info fmt (v:Descriptor_types.generated_code_info) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "annotation" (Pbrt.Pp.pp_list pp_generated_code_info_annotation) fmt v.Descriptor_types.annotation;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
